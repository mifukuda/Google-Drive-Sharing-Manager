...
import { createSnapshot, getSnapshotInfo, getSnap, updateSnap, checkPolicies, analyzeSharing, querySnap } from '../controllers';
...
router.get('/analyze', verifyToken, analyzeSharing)
